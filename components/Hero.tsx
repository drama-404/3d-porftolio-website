  ...
  return (
    <div className="relative w-full min-h-screen bg-base-darker overflow-x-hidden font-sans text-text-primary selection:bg-accent-cyan selection:text-base-darker">
        ...
        <div className="relative z-10 w-full max-w-[1600px] mx-auto flex flex-col">
            ...
            <div id="hero-section" className="relative flex flex-col min-h-[100dvh] w-full px-6 sm:px-12 md:px-16 lg:px-24 pb-10">

                <main className="flex-1 flex flex-col justify-center max-w-3xl pt-24 md:pt-28 lg:pt-16">
                  <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl leading-[1.15] font-display font-bold text-text-primary tracking-[-0.02em] mb-6 md:mb-8">
